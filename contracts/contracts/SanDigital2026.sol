...
/**
 * @title SanDigital2026 - Modelo 40 USDT Optimizado
 * @notice Sistema de ahorro colectivo (NO es inversión)
 *
 * CARACTERÍSTICAS:
 *  ✅ EXIT_THRESHOLD: 40 USDT
 *  ✅ Posiciones ilimitadas por usuario
 *  ✅ Gas optimizado con accGlobalPerShare
 *  ✅ Transparencia total del sistema
 *
 * Modelo económico:
 *  - Aporte: 20 USDT por posición
 *  - 10 USDT → usuario en turno
 *  - 9 USDT → global (todos los activos)
 *  - 1 USDT → administración
 *  - Salida automática al alcanzar 40 USDT
 */
contract SanDigital2026 is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant APORTE          = 20_000000;  // 20 * 10^6
    uint256 public constant TURN_PAYOUT     = 10_000000;  // 10 * 10^6
    uint256 public constant GLOBAL_PAYOUT   =  9_000000;  // 9  * 10^6
    uint256 public constant ADMIN_FEE       =  1_000000;  // 1  * 10^6
    uint256 public constant EXIT_THRESHOLD = 40_000000;     // 40 USDT
