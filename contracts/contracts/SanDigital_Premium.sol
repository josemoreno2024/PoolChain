...
/**
 * @title SanDigital_Premium - Tier Premium (40→80 USDT)
 * @notice Sistema de ahorro colectivo (NO es inversión)
 *
 * CARACTERÍSTICAS:
 *  ✅ EXIT_THRESHOLD: 80 USDT
 *  ✅ Posiciones ilimitadas por usuario
 *  ✅ Distribución directa optimizada
 *  ✅ Transparencia total del sistema
 *
 * Modelo económico:
 *  - Aporte: 40 USDT por posición
 *  - 19.5 USDT → usuario en turno
 *  - 19.5 USDT → global (todos los activos)
 *  - 1 USDT → administración (2.5%)
 *  - Salida automática al alcanzar 80 USDT
 */
contract SanDigital_Premium is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant APORTE          = 40_000000;  // 40 * 10^6
    uint256 public constant TURN_PAYOUT     = 19_500000;  // 19.5 * 10^6
    uint256 public constant GLOBAL_PAYOUT   = 19_500000;  // 19.5 * 10^6
    uint256 public constant ADMIN_FEE       =  1_000000;  // 1 * 10^6
    uint256 public constant EXIT_THRESHOLD = 80_000000;   // 80 USDT
