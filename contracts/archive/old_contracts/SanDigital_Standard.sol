...
/**
 * @title SanDigital_Standard - Tier Standard (20→40 USDT)
 ...
 *  - 9.5 USDT → usuario en turno
 *  - 9.5 USDT → global (todos los activos)
 *  - 1 USDT → administración (5%)
 *  - Salida automática al alcanzar 40 USDT
 */
contract SanDigital_Standard is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant TURN_PAYOUT     =  9_500000;  // 9.5 * 10^6
    uint256 public constant GLOBAL_PAYOUT   =  9_500000;  // 9.5 * 10^6
