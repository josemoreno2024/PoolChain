...
/**
 * @title SanDigital_Elite - Tier Elite (50→100 USDT)
 * @notice Sistema de ahorro colectivo (NO es inversión)
 *
 * CARACTERÍSTICAS:
 *  ✅ EXIT_THRESHOLD: 100 USDT
 *  ✅ Posiciones ilimitadas por usuario
 *  ✅ Distribución directa optimizada
 *  ✅ Transparencia total del sistema
 *
 * Modelo económico:
 *  - Aporte: 50 USDT por posición
 *  - 24.5 USDT → usuario en turno
 *  - 24.5 USDT → global (todos los activos)
 *  - 1 USDT → administración (2%)
 *  - Salida automática al alcanzar 100 USDT
 */
contract SanDigital_Elite is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant APORTE          = 50_000000;  // 50 * 10^6
    uint256 public constant TURN_PAYOUT     = 24_500000;  // 24.5 * 10^6
    uint256 public constant GLOBAL_PAYOUT   = 24_500000;  // 24.5 * 10^6
    uint256 public constant ADMIN_FEE       =  1_000000;  // 1 * 10^6
    uint256 public constant EXIT_THRESHOLD = 100_000000;  // 100 USDT
