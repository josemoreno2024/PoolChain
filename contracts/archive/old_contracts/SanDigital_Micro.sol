...
/**
 * @title SanDigital_Micro - Tier Micro (10→20 USDT)
 * @notice Sistema de ahorro colectivo (NO es inversión)
 *
 * CARACTERÍSTICAS:
 *  ✅ EXIT_THRESHOLD: 20 USDT
 ...
 *  - 4.5 USDT → usuario en turno
 *  - 4.5 USDT → global (todos los activos)
 *  - 1 USDT → administración (10%)
 *  - Salida automática al alcanzar 20 USDT
 */
contract SanDigital_Micro is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant APORTE          = 10_000000;  // 10 * 10^6
    uint256 public constant TURN_PAYOUT     =  4_500000;  // 4.5 * 10^6
    uint256 public constant GLOBAL_PAYOUT   =  4_500000;  // 4.5 * 10^6
    uint256 public constant ADMIN_FEE       =  1_000000;  // 1 * 10^6
    uint256 public constant EXIT_THRESHOLD = 20_000000;   // 20 USDT
