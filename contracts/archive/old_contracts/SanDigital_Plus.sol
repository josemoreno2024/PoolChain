...
/**
 * @title SanDigital_Plus - Tier Plus (30→60 USDT)
 * @notice Sistema de ahorro colectivo (NO es inversión)
 *
 * CARACTERÍSTICAS:
 *  ✅ EXIT_THRESHOLD: 60 USDT
 *  ✅ Posiciones ilimitadas por usuario
 *  ✅ Distribución directa optimizada
 *  ✅ Transparencia total del sistema
 *
 * Modelo económico:
 *  - Aporte: 30 USDT por posición
 *  - 14.5 USDT → usuario en turno
 *  - 14.5 USDT → global (todos los activos)
 *  - 1 USDT → administración (3.3%)
 *  - Salida automática al alcanzar 60 USDT
 */
contract SanDigital_Plus is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public constant APORTE          = 30_000000;  // 30 * 10^6
    uint256 public constant TURN_PAYOUT     = 14_500000;  // 14.5 * 10^6
    uint256 public constant GLOBAL_PAYOUT   = 14_500000;  // 14.5 * 10^6
    uint256 public constant ADMIN_FEE       =  1_000000;  // 1 * 10^6
    uint256 public constant EXIT_THRESHOLD = 60_000000;   // 60 USDT
